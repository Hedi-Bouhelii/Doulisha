...
| #    | Decision                                                                                    | Status   |
| ---- | ------------------------------------------------------------------------------------------- | -------- |
| 0001 | [Monorepo with pnpm workspaces and Turborepo](0001-monorepo-pnpm-turborepo.md)              | Accepted |
...
| 0004 | [Expo, Expo Router and NativeWind for mobile](0004-expo-mobile.md)                          | Accepted |
